...
// var ignoreFiles = ['package.json', 'package-lock.json', '.eslintrc.js']
...
fis.match('node_modules/**.js', {
  ...
  parser: fis.plugin('babel-6.x', {
    compact: true
  }) // 这里不加配置只对es6的基础语法做转换，注意这里不能加es6垫片
})

fis.match('{template,widget,component}/**.js', {
  isMod: true,
  useMap: true,
